...
A small counting frame used for calculations and bookkeeping. It is often used by merchants, accountants, and scholars.
...
When you take the Attack action, you can replace one of your attacks with throwing a vial of acid. Target one creature or object you can see within 20 feet of yourself. The target must succeed on a Dexterity saving throw (DC 8 + your Dexterity modifier + Proficiency Bonus) or take 2d6 acid damage.

#### Adamantine Arrow
**Weight:** 0.05 lb.
**Cost:** 55 gp
**Type:** Weapon (ammunition, arrow)

Ammunition made of or coated with adamantine is unusually effective when used to break objects. Whenever an adamantine arrow hits an object, the hit is a critical hit.

The adamantine version of a single arrow costs 50 gp more than a normal arrow, whether the arrow is made of the metal or coated with it.

#### Adamantine Crossbow Bolt
**Weight:** 0.075 lb.
**Cost:** 55 gp
**Type:** Weapon (ammunition, crossbow bolt)

Ammunition made of or coated with adamantine is unusually effective when used to break objects. Whenever an adamantine crossbow bolt hits an object, the hit is a critical hit.

The adamantine version of a single crossbow bolt costs 50 gp more than a normal bolt, whether the bolt is made of the metal or coated with it.

#### Adamantine Blowgun Needle
**Weight:** 0.02 lb.
**Cost:** 50 gp
**Type:** Weapon (ammunition, blowgun needle)

Ammunition made of or coated with adamantine is unusually effective when used to break objects. Whenever an adamantine blowgun needle hits an object, the hit is a critical hit.

The adamantine version of a single blowgun needle costs 50 gp more than a normal needle, whether the needle is made of the metal or coated with it.

#### Adamantine Sling Bullet
**Weight:** 0.04 lb.
**Cost:** 50 gp
**Type:** Weapon (ammunition, sling bullet)

Ammunition made of or coated with adamantine is unusually effective when used to break objects. Whenever an adamantine sling bullet hits an object, the hit is a critical hit.

The adamantine version of a single sling bullet costs 50 gp more than a normal bullet, whether the bullet is made of the metal or coated with it.
...
This sticky, adhesive fluid ignites when exposed to air. As an action, you can throw this flask up to 20 feet, shattering it on impact. Make a ranged attack against a creature or object, treating the alchemist's doom as an improvised weapon. On a hit, the target takes 2d6 fire damage at the start of each of its turns. A creature can end this damage by using its action to make a DC 10 Dexterity check to extinguish the flames.
...
#### Asp Vine Whip
**Weight:** 3 lb.
**Type:** Weapon (martial melee weapon, whip)
...
A creature subjected to assassin’s blood makes a DC 10 Constitution saving throw. On a failed save, the creature takes 1d12 poison damage and has the Poisoned condition for 24 hours. On a successful save, the creature takes half as much damage only.
...
#### Balm of Shifting Form
**Weight:** 0.5 lb.
**Type:** Adventuring Gear

This alchemical concoction was derived from research into the transmutation effects of olothec slime. When a creature uses an action to rub this balm onto their body, they can alter their superficial features, such as changing the color of their skin, hair, and eyes and reshaping their ears and facial features. The balm doesn't allow a creature to take on another specific creature's form, but it can be used to alter appearance and apparent ancestry with ease. A creature using the balm adds double their proficiency bonus to any ability checks they make to create a visual disguise, and they have advantage on those checks. The effects of the balm last until the creature finishes a long rest.

A character who studies a sample of balm for 1 week and succeeds on a DC 18 Intelligence (Arcana) or Wisdom (Medicine) check can create a recipe for it. Using the recipe, a character can create one dose of balm with 8 hours of work at a cost of 125 gp. Using slime collected from an olothec lair or a dead olothec as a reagent reduces the cost by half.
...
**Weight:** 4 lb.
**Cost:** 10 gp
**Type:** Weapon (martial melee weapon, battleaxe)
...
A creature subjected to this poison must succeed on a DC 16 Constitution saving throw or become poisoned for 1 minute. The poisoned creature must use its action to make a melee attack against a randomly determined creature within its reach. If there is no other creature within its reach, the creature does nothing on its turn. The creature can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.
...
A creature that consumes this seed is affected by the spell *feign death*. If unwilling or unaware, it can resist with a DC 16 Constitution saving throw. Otherwise, it counts as a willing target.
...
A creature subjected to a dose cannot be charmed or frightened for 1d6 hours. Each dose requires a DC 15 Constitution saving throw or the creature becomes poisoned for 2d4 hours; effects stack with multiple doses.
...
A lustrous black gemstone with glowing highlights.
...
Volatile alchemical powder that explodes when ignited by flame or fuse. Each creature within 5 feet makes a DC 13 Dexterity saving throw, taking 3d6 bludgeoning damage on a failed save, or half on a success. Multiple pouches can be combined: each additional pouch adds +1d6 damage (max 10d6) and +5 ft radius (max 20 ft).
...
A creature that consumes a dose gains advantage on Intelligence and Wisdom checks for 1 hour but gains vulnerability to psychic damage. It must succeed on a DC 15 Constitution saving throw or become poisoned for 1d6 hours and suffer the effects of *confusion* for 1 minute. Undead instead gain advantage on Dexterity checks and immunity to frightened for 1 hour.
...
A creature subjected to this poison must succeed on a DC 12 Constitution saving throw or be cursed with lycanthropy. The type depends on the source: Wererat (1–3), Werewolf (4–5), Wereboar (6). The curse lasts until removed by *remove curse* or similar magic.
...
**Weight:** 1 lb.
**Cost:** 10 gp
**Type:** Weapon (martial ranged weapon, blowgun)

1 piercing.

Ammunition (range 25/100 ft; needle), loading. You can make a ranged attack only if you have ammunition. Each attack expends one piece. You need a free hand to load. After combat, half of expended ammunition can be recovered.

Mastery: Vex. On a hit, you gain advantage on your next attack roll against the same creature before the end of your next turn.
...
Used for ranged attacks. One bolt is expended per attack; half can be recovered after combat.
...
As an action, you can throw and ignite a bomb up to 60 feet. Each creature in a 5-foot-radius sphere makes a DC 12 Dexterity saving throw, taking 3d6 fire damage on a failed save or half on a success.
...
A nonfiction book about a topic grants a +5 bonus to Intelligence (Arcana, History, Nature, or Religion) checks related to that topic.
...
Artisan's Tool. Artisan’s Tools are each focused on crafting items and pursuing a trade. Each type requires a separate proficiency. If you have proficiency with a tool, add your Proficiency Bonus to any ability check you make with it. If you have proficiency in a skill used for the check, you have Advantage on the check.
...
You can use a Bonus Action to furl or unfurl the cloak. When unfurled, it sheds bright light in a 5-foot radius and dim light for another 5 feet. The cloak contains 1 pound of edible fungus; once consumed, it becomes ordinary traveler’s clothes.
...
A burglar’s pack contains: Backpack, Ball Bearings, Bell, 10 Candles, Crowbar, Hooded Lantern, 7 flasks of Oil, 5 days of Rations, Rope, Tinderbox, and Waterskin.
...
A creature subjected to this poison must succeed on a DC 13 Constitution saving throw or take 3d6 poison damage and repeat the save at the start of each of its turns. Each failed save after the first deals 1d6 poison damage. After three successful saves, the effect ends.
...
Utilize: Write text with flourishes that resist forgery (DC 15)  

Craft: Ink, Spell Scroll  

Artisan’s Tool. If you have proficiency, add your Proficiency Bonus to related ability checks, and gain Advantage if the check overlaps with a relevant skill.
...
You can use a Utilize action to scatter caltrops in a 5-foot-square area within 5 feet. A creature entering the area must succeed on a DC 15 Dexterity saving throw or take 1 piercing damage and have its speed reduced to 0 until the start of its next turn.
...
A lit candle sheds bright light in a 5-foot radius and dim light for an additional 5 feet for 1 hour.
...
Artisan’s Tool. If you have proficiency with these tools, add your Proficiency Bonus to ability checks made with them, and gain Advantage if the check overlaps with a relevant skill.
...
A creature subjected to this poison must succeed on a DC 13 Constitution saving throw or become Poisoned for 1 minute. While Poisoned in this way, the creature is also Paralyzed. The creature repeats the save at the end of each of its turns, ending the effect on a success.
...
You can use a Utilize action to wrap a chain around a creature within 5 feet that is Grappled, Incapacitated, or Restrained with a successful DC 13 Strength (Athletics) check. If its legs are bound, it gains the Restrained condition until it escapes. Escaping requires a DC 18 Dexterity (Acrobatics) check. The chain can be broken with a DC 20 Strength (Athletics) check.
...
AC 16. The wearer has Disadvantage on Dexterity (Stealth) checks. If the wearer has a Strength score lower than 13, their speed is reduced by 10 feet.
...
A small piece of chalk used for marking surfaces.
...
Tool (musical instrument). If you have proficiency, add your Proficiency Bonus to ability checks made with it, and gain Advantage if the check overlaps with a relevant skill.
...
Includes boot tips, gloves, pitons, and a harness. As a Utilize action, you can anchor yourself; while anchored, you cannot fall more than 25 feet from the anchor point and cannot move more than 25 feet from it without undoing the anchor as a Bonus Action.
...
As long as it remains dry, the wearer automatically succeeds on saving throws against extreme cold.
...
**Weight:** 2 lb.
**Cost:** 1 sp
**Type:** Weapon (simple melee weapon, club)

1d4 bludgeoning.

Light. When you take the Attack action and attack with a Light weapon, you can make one extra attack as a Bonus Action with a different Light weapon. You don’t add your ability modifier to that extra attack’s damage unless it is negative.

Mastery: Slow. On a hit, you can reduce the target’s speed by 10 feet until the start of your next turn.
...
Artisan’s Tool. If you have proficiency, add your Proficiency Bonus to checks made with the tools, and gain Advantage if the check overlaps with a relevant skill.

#### Cold Iron Weapon
**Weight:** — lb.
**Cost:** varies (+100 gp or double base cost, whichever is higher)
**Type:** Weapon (generic variant)

Lords and ladies of the fey courts are timeless creatures, inured to many of the world's threats. A universal exception to this is weapons of cold-wrought iron. This metal undoes the very fabric of a fey creature's life as it blights their ageless flesh. A cold iron weapon is treated as magical when used against any fey creature, and is the only weapon with any hope of harming the most powerful fey lords and ladies. However, cold iron weapons are difficult to construct. The skill and material required to produce such a weapon doubles its price or adds 100 gp to the cost, whichever is more. Finding a smith with the skill to make a durable weapon without the aid of fire is always difficult—and finding one with the courage to anger the fey courts may be even harder.
...
A set of ordinary clothes suitable for everyday wear. The clothing is simple and inexpensive, often worn by common folk and travelers.
...
**Weight:** 1 lb.
**Cost:** 2 gp
**Type:** Weapon (simple melee weapon, dagger)
...
A creature subjected to Deathdance must succeed on a DC 13 Constitution saving throw or have the Poisoned condition for 1 minute. Humanoids automatically succeed on this save. The creature also has the Incapacitated condition while Poisoned in this way, as it thrashes uncontrollably.
...
When you are wearing Desert Clothing and not wearing Medium or Heavy armor, you automatically succeed on saving throws against the effects of extreme heat.
...
These spices procured from the far-off desert of Dustbloom are prized for their unique and peppery flavor.
...
Guilds, nobles, and royalty regulate trade. Chartered companies are granted rights to conduct trade along certain routes, to send merchant ships to various ports, or to buy or sell specific goods or services. Guilds set prices for the goods or services that they control, and determine who may or may not offer those goods and services. Merchants commonly exchange trade goods without using currency.
...
This fine everwine is made from elderberries specially cultivated by forest vintners. It is highly prized among the Alderheart elite for its heady bouquet and dry sweetness.
...
**Weight:** 0.1 lb.
**Cost:** 5 gp
**Type:** Spellcasting Focus (Holy Symbol, Wondrous Item)

An Emblem is a Holy Symbol that must be borne on fabric (such as a tabard or banner) or a shield to be effective. A Holy Symbol takes a specific form and is bejeweled or painted to channel divine magic. A Cleric or Paladin can use a Holy Symbol as a Spellcasting Focus.
...
Embroidered glove set with jewel chips. Treasure (Art Object). Idols cast of solid gold, necklaces studded with precious stones, paintings of ancient kings, bejeweled dishes—art objects include all these and more.
...
Embroidered silk and velvet mantle set with numerous moonstones. Treasure (Art Object). Idols cast of solid gold, necklaces studded with precious stones, paintings of ancient kings, bejeweled dishes—art objects include all these and more.
...
A finely crafted silk handkerchief, often treated as a minor luxury or decorative art object.
...
Gaming Set. If you are proficient with a gaming set, you can add your proficiency bonus to ability checks you make to play a game with that set.
...
An Entertainer's Pack contains: Backpack, Bedroll, Bell, Bullseye Lantern, 3 Costumes, Mirror, 8 flasks of Oil, 9 days of Rations, Tinderbox, Waterskin.
...
A creature subjected to Essence of Ether must succeed on a DC 15 Constitution saving throw or gain the Poisoned condition for 8 hours and also be Unconscious while Poisoned. The creature wakes if it takes damage or if another creature uses an action to shake it awake.
...
An Explorer's Pack contains: Backpack, Bedroll, 2 flasks of Oil, 10 days of Rations, Rope, Tinderbox, 10 Torches, Waterskin.
...
An acorn-sized brass sphere with blasting powder and a clockwork trigger. Thrown up to 30 feet as an action; detonates on impact. Creatures within 5 feet must make a DC 10 Dexterity saving throw, taking 1d8 bludgeoning damage on a failure or half on a success.
...
A circular gemstone of gray, white, brown, blue, or green coloration.
...
A decorative eye patch adorned with sapphires and moonstones, valued as an art object.
...
A creature exposed must succeed on a DC 14 Constitution saving throw or be poisoned for 1 hour and blinded while poisoned. Lesser restoration or similar magic ends the effect.
...
Paired backpack devices that enable long-distance communication via radio signals. While wearing one, a user can send a 25-word message to its paired device within 18 miles. The message broadcasts within 10 feet. If unused, it emits static.
...
Expensive clothing with detailed craftsmanship, often required for entry into certain events or locations.
...
A luxurious gold chain set with a fire opal, treated as a valuable art object.
...
A high-quality bottle of wine used in formal or celebratory settings.
...
This poison is harvested from the venom sac of a dead or incapacitated firelance. A creature subjected to this poison must make a DC 11 Constitution saving throw, taking 14 (4d6) poison damage on a failed save or half as much on a successful one. If the poison damage reduces a creature to 0 hit points, it is poisoned for 1 hour, even after regaining hit points. A single dose of this poison costs 300 gold pieces.
...
#### Gift of the Wind-Touched Jerbeen Figurine

**Weight:** 0.5 lb.
**Cost:** 10 gp
**Type:** Treasure (Art Object)

A figurine carved from a single piece of wood, it appears hastily made, but it does vaguely resemble a jerbeen. Said to be carved from wood from the Greenkeeper farmstead.
...
A lavishly crafted royal coach or ceremonial funeral barge, richly gilded and treated as a high-value art object.
...
Mastery: Graze. If your attack roll with this weapon misses a creature, you can deal damage equal to the ability modifier used for the attack roll. This damage is the same type as the weapon.
...
Artisan’s Tool. If you have proficiency with a tool, add your Proficiency Bonus to any ability check you make that uses the tool. If you have proficiency in a skill that's used with that check, you have Advantage on the check too.
...
#### Grace of the Wind-Touched Jerbeen Figurine

**Weight:** 0.5 lb.
**Cost:** 50 gp
**Type:** Treasure (Art Object)

An ornate figurine of a jerbeen with wings carved with an impressive level of craftsmanship. Said to be made of branches gifted by the Wind-Touched from her own home in the forest.
...
Mastery: Cleave. If you hit a creature with a melee attack roll using this weapon, you can make a melee attack roll with it against a second creature within 5 feet of the first. On a hit, the second creature takes the weapon’s damage without adding your ability modifier unless it is negative.
...
Mastery: Push. If you hit a creature with this weapon, you can push it up to 10 feet straight away if it is Large or smaller.
...
Mastery: Graze. If your attack roll with this weapon misses a creature, you can deal damage equal to your ability modifier used for the attack roll. This damage is the same type as the weapon.

Got it — I won’t truncate or summarize rules text anymore.

Here’s the full, properly formatted version:
...
Damage: 1d6 Piercing
Properties: Ammunition (Range 30/120 ft.; Bolt), Light, Loading
Mastery: Vex
...
Properties: Ammunition (Range 100/400 ft.; Bolt), Heavy, Loading, Two-Handed
Mastery: Push

Range. A Range weapon has a range in parentheses after the Ammunition or Thrown property. The range lists two numbers. The first is the weapon's normal range in feet, and the second is the weapon's long range. When attacking a target beyond normal range, you have Disadvantage on the attack roll. You can't attack a target beyond the long range.

Ammunition. You can use a weapon that has the Ammunition property to make a ranged attack only if you have ammunition to fire from it. The type of ammunition required is specified with the weapon's range. Each attack expends one piece of ammunition. Drawing the ammunition is part of the attack.

Heavy. You have Disadvantage on attack rolls with a Heavy weapon if it's a Melee weapon and your Strength score isn't at least 13 or if it's a Ranged weapon and your Dexterity score isn't at least 13.

Loading. You can fire only one piece of ammunition from a Loading weapon when you use an action, Bonus Action, or Reaction to fire it.
...
Loading. You can fire only one piece of ammunition per action, Bonus Action, or Reaction.
...
Light. When you take the Attack action and attack with a Light weapon, you can make one extra attack as a Bonus Action later on the same turn.
...
Ammunition. Each attack expends one piece of ammunition. Drawing ammunition is part of the attack. After a fight, you can recover half your expended ammunition by spending 1 minute.

If used as a melee weapon, it is treated as an improvised weapon.
...
Damage: 1d6 Psychic
Psiactive, two-handed, range 30/120 ft.

Range. A weapon has a normal and long range; attacks beyond normal range have Disadvantage.

Psiactive. Uses Intelligence or Charisma for attack and damage rolls. Limited uses tied to proficiency bonus.
...
Damage: 1d8 Piercing
Properties: Ammunition (Range 150/600 ft.; Arrow), Heavy, Two-Handed
Mastery: Slow

Range. A weapon has a normal and long range; attacks beyond normal range have Disadvantage. You can’t attack beyond long range.
...
Mastery: Slow. If you hit a creature with this weapon and deal damage to it, you can reduce its Speed by 10 feet until the start of your next turn.
...
Instrument. If you have proficiency with a musical instrument, you can add your proficiency bonus to any ability checks you make to play music with the instrument. A bard can use a musical instrument as a spellcasting focus.
...
Versatile. Can be used with one or two hands; deals 1d10 when used two-handed.
...
A Magnifying Glass grants Advantage on any ability check made to appraise or inspect a highly detailed item. Lighting a fire requires sunlight, tinder, and about 5 minutes.
