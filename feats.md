...
{{frontCover}}
:::::::::::::::::::::::::::::::
#  Dorthos' Records <small>of</small> Extraordinary Deeds
___
...
{{footnote
A Collection of DnD 5e Feats
}}

![front cover image](https://i.imgur.com/d94qUKa.jpg) {right:0px,top:0px,height:107%}
...
**Mimicry.** You can mimic the sounds of other creatures, including speech. A successful Wisdom (Insight) check contested by your Charisma (Deception) check allows a listener to determine that the effect is faked.
...
**Artificer’s Craft.** You learn one cantrip from the artificer spell list. Intelligence is your spellcasting ability for this spell.  
...
You gain a fierce vitality in battle, drawing strength from the clash of steel and the suffering of your foes.

You gain the following benefits.

**Ability Score Increase.** Increase your Strength, Dexterity, or Constitution by 1, to a maximum of 20.

**Powerful Recovery.** When you roll a Hit Point Die to regain Hit Points, you can treat any roll lower than half the die’s maximum as equal to half the die’s maximum (rounded up). For example, a roll of 1 or 2 on a d6 becomes 3.

**Sanguine Feast.** Once per turn when you hit a Bloodied creature that isn't a Construct or Undead with an attack roll, you can expend one of your Hit Point Dice, roll it, and regain a number of Hit Points equal to the number rolled plus your Constitution modifier.    

### Bomber

You have honed your skill at hurling explosive vials, volatile concoctions, and other thrown implements with deadly accuracy and force.

You gain the following benefits.

**Ability Score Increase.** Increase your Dexterity score by 1, to a maximum of 20.

**Far Lobber.** When you throw a vial or flask, you can target an object or creature you can see within 40 feet of yourself.

**Dexterous Toss.** You can throw a vial or flask as a Bonus Action. In addition, when you hit with a vial or flask, you add your Dexterity modifier to the damage roll.  

**Alchemical Expertise.** You gain proficiency with Alchemist’s Supplies. In addition, at the end of a Long Rest, you can create a number of alchemist’s fire, acid, holy water, or oil flasks equal to your Proficiency Bonus, instead of one. Those items retain their potency until you finish a Long rest.
...
**Ability Score Increase.** Increase your Dexterity, Intelligence or Charisma by 1, to a maximum of 20.  
...
**Replenishing Meal.** As part of a Short Rest, you can cook special food if you have ingredients and Cook's Utensils on hand. You can prepare enough of this food for a number of creatures equal to 4 plus your Proficiency Bonus. Each creature that spends Hit Dice as part of the Short Rest, regains 2 additional hit points per Hit Die spent.

**Bolstering Treats.** With 1 hour of work or when you finish a Long Rest, you can cook a number of treats equal to your Proficiency Bonus if you have ingredients and Cook's Utensils on hand. These special treats last 8 hours after being made. A creature can use a Bonus Action to eat one of those treats to gain a number of Temporary Hit Points equal to your character level.  

### Child of the Moon

You are blessed with the ethereal light of the moon, guiding allies and revealing hidden foes.

You gain the following benefits.

**Ability Score Increase.** Increase your Intelligence, Wisdom, or Charisma by 1, to a maximum of 20.

**Moonlit Vision.** You and allies within 10 feet of you have Advantage on saving throws made to avoid or end the Blinded condition.
...
**Tool Proficiency.** You gain proficiency with both mason’s tools and painter’s supplies. Whenever you make an ability check with either tool, you can treat a roll of 9 or lower on the d20 as a 10. You can use mason’s tools or painter’s supplies and the appropriate materials to create a work of fine art worth 50 gp for each workday you spend working on it. 

**Masterpiece.** When you create a work of art, you can imbue it with magical properties. Choose one 1st-level spell from the following list: *Bless, Charm Person, Color Spray, Command, Cure Wounds, Disguise Self, Heroism, Sanctuary or Sleep*. While holding that work of art, you can cast the spell within expending any spell slot you have. Additionally, as an action, you can cast the chosen spell on a single creature within 30 feet of your artwork without expending a spell slot or using any components. Once you use this ability to cast a spell from a work of art, you cannot do so from that work of art until you finish a long rest. The ability score increased by this feat is the spellcasting ability modifier for these spells.
...
**Grasping Mist.** Whenever you cast *Fog Cloud*, nonmagical flames in the spell's sphere are extinguished, and creatures other than you and your allies have their Speed reduced by 10 feet while in the spell's sphere.  
Allies within the fog benefit from half cover while inside the mist.

### Cold Caster

You command the biting chill of winter, slowing your foes and leaving frost in your wake.
...
**Expert Crafter.** Whenever you craft an item using any type of Tools that you are proficient in, it takes only half the normal time to craft the item.  
...
### Cruel
The challenges and struggles you've faced throughout your life have led you to delight in inflicting pain and anguish upon others. 

**Ability Score Increase.** Increase your Strength or Charisma by 1, to a maximum of 20.

**Cruelty Dice.** You gain a number of cruelty dice equal to your proficiency bonus. Your cruelty dice are d6s. You can roll only one cruelty die per turn, and a cruelty die is spent when you roll it. You regain all spent cruelty dice when you finish a long rest. Your cruelty dice beomce d8s at level 5, d10s at level 11 and d12s at level 17.  

**Extra Damage.** When you deal damage to a creature, spend one cruelty die to deal extra damage to the creature equal to the roll.  
...
You move through the shadows with charm and song, turning your music into a tool to aid allies and confound enemies.
...
**Distracting Melody.** When you take the Help action to assist an ally's attack roll, the enemy you're distracting can be within 30 feet of you, rather than within 5 feet, provided the enemy can see or hear you. Additionally, the first time the ally you assisted hits the target before the start of your next turn, the attack deals extra damage equal to your Proficiency Bonus.
...
**Devious Exploits.** You learn two 1st-degree Devious Exploits of your choice from those available to the Rogue. If an Exploit requires the target to make a saving throw to resist it, the DC equals 8 + your proficiency bonus + your Strength or Dexterity modifier (your choice).  

**Exploit Change.** Each time you gain a level, you can replace one Exploit with another 1st-degree Devious Exploit of your choice.  
...
**Cantrip and Level 1 Spell.** You learn one cantrip of your choice from the cleric spell list and one 1st-level spell based on the alignment of your character, as specified in the Alignment Spells table below. You also learn the augury spell.  
...
**Holy Symbol Focus.** In addition, you can use a holy symbol as a spellcasting focus for any spell you cast that uses the spellcasting ability you choose when you select this feat.  

### Dragon Initiate

You have embraced the power and majesty of dragons, speaking their tongue and inspiring awe—or terror—in those around you.

You gain the following benefits.

**Ability Score Increase.** Increase your Intelligence, Wisdom, or Charisma by 1, to a maximum of 20.

**Dragon's Tongue.** You know Draconic. If you already know Draconic when you select this feat, you instead learn one language of your choice from the language tables in the Player's Handbook.
...
**Skill Proficiency.** You gain proficiency in your choice of either Perception or Investigation, and thieves' tools. Moreover, when you make an ability check using any of these proficiencies, you can treat a roll of 7 or lower on the d20 as an 8.  

**Trap Sense.** You have advantage on saving throws to avoid or resist traps and are resistant to the damage dealt by traps.  

**Quick Explorer.** Traveling at a fast pace in a dungeon does not impose the normal penalty on your passive Investigation and Perception scores.  
...
**Speedy Recovery.** As a Bonus Action, you can expend one of your Hit Point Dice, roll the die, and regain a number of Hit Points equal to the roll + your Constitution modifier.  
...
**Ability Score Increase.** Increase your Charisma, Wisdom, or Intelligence modifier by 1, up to a maximum of 20.  
...
You move with a playful cunning, weaving mischief into your attacks and slipping through danger with ease.
...
**Weapon Proficiency.** You gain proficiency with all simple and martial weapons.  
...
**Wish Magic.** As a Magic action, you can produce the effects of a level 1 spell of your choice that has a casting time of an action. Once you use this benefit, you can't do so again until you finish a Long Rest. The spell's spellcasting ability is the ability increased by this feat.  
...
**Heavy Weapon Mastery.** Once per turn, when you hit a creature with a weapon that has the Heavy property as part of the Attack Action on your turn, you can cause the weapon to deal extra damage to the target. The extra damage equals your Proficiency Bonus. Alternatively, if you hit a creature that is equal to your size or smaller with a heavy melee weapon attack, you can forgo dealing the extra damage to knock it back 5 feet away from you in a line, so long as that space is unoccupied. 
...
**Firearm Proficiency.** You gain proficiency with firearms (see "Firearms" in the Dungeon Master's Guide).  

**Expert Marksman.** You ignore the loading property of firearms.  

**Close Quarters Sharpshooter.** Being within 5 feet of a hostile creature doesn't impose disadvantage on your ranged attack rolls. 

### Guardian Initiate

You stand as a steadfast shield for your allies, using skill and vigilance to keep them safe from harm.
...
**Vigilant.** When you take the Ready action, you also take the Dodge action.

### Hardy Physique
***Prerequisite: Constitution of 13 or higher***

You have hardened your physical body to absorb hits rather than dodge them. 
...
**Healing Rerolls.** Whenever you roll a die to determine the number of Hit Points you restore with an abiltiy, spell or with this feat's Battle Medic benefit, you can reroll the die if it rolls a 1, and you must use the new roll.  
...
**Cantrip and Level 1 Spells.** Choose one of the three ways to influence your magic: black magic, red magic, or white magic. You learn one cantrip of your choice from the wizard spell list and two 1st-level spells based on the way you choose, as specified in the High Sorcery Spells table.

##### High Sorcery Spells
|Way|	1st-Level Spell
|:----:|:----:|
|Black|	Choose two from *dissonant whispers, false life, hex, and ray of sickness*
|Red|	Choose two from *color spray, disguise self, feather fall, and longstrider*
|White|	Choose two from *comprehend languages, detect evil and good, protection from evil and good, and shield*
...
**Encouraging Performance.** If you do not have a *Leadership Ability*, it is the ability you increased with this feat. When you finish a Short or Long Rest, you can give an inspiring performance: a speech, song, or dance. When you do so, choose up to six allies (which can include yourself) within 30 feet of yourself who witness the performance. The chosen creatures each gain Temporary Hit Points equal to your character level plus your *Leadership Ability* modifier.
...
**Intimidating Presence.** When another creature within 30 feet of you that can also see or hear you fails a saving throw to resist the Charmed or Frightened condition, you can use a reaction to make an Intimidation check against the same save DC. On a success, the creature is not Charmed or Frightened.

You can use this reaction a number of times equal to your Proficiency Bonus, and you regain all expended uses of this feature when you finish a long rest.
\page
{{pageNumber,auto}}
### Keen Mind
...
You lead with courage and inspire those around you, turning your victories into opportunities for your allies to shine.
...
### Legendary Might
You have always found ways to leverage your great might for additional benefits.

**Ability Score Increase.** Increase your Constitution by 1, to a maximum of 20.

**Iron Ascendance.** You gain the benefits on the table below that correspond to your Strength modifier and lower.

Should your Strength modifier increase, the benefits that you gain from this Feat also increase with your modifier:

| Modifier |                     Benefit Description                                                                                       |
|----------|---------------------------------------------------------------------------------------------------------------------------------------------|
...
| +3       | You gain a climbing speed and a swimming speed equal to your walking speed.|
| +4       | 	When making an Athletics check, you treat any roll of 7 or lower on a d20 as an 8.|
| +5       | When forced to make a Constitution saving throw, you can choose to make a Strength saving throw instead.|
\column
### Lifelong Learner
...
**Ever-learning.** You gain the benefits from the table below that correspond to your Intelligence modifier and lower. If your Intelligence modifier increases, the benefits you gain from this Feat also increase with your modifier:

|Modifier|	Benefit
|:---:|:---|
| +1    | **Linguistic Expansion.** You learn to speak, read, and write one additional language of your choice. |
| +2    | **Mind Over Manner.** You can make Intelligence (Persuasion) checks in place of Charisma (Persuasion) checks. |
| +3    | **Skill Proficiency.** You gain proficiency in either Arcana, History, or Religion. |
| +4    | **Enhanced Skill.** For one skill proficiency of your choice, you treat a roll of 7 or lower on the d20 as an 8. |
| +5    | **Flexible Resilience.** Whenever you are forced to make a Wisdom saving throw, you can choose to make an Intelligence saving throw instead. |

### Light Bringer

You are infused with radiant energy, learning to manipulate light and heal with the warmth of the sun.
...
**Solar Luminance.** When you cast a spell or create any other effect that produces light, you can have it radiate sunlight. Once you use this benefit, you can't use it again until you finish a Short or Long Rest.

**Sun's Healing.** As a Bonus Action while within sunlight, you can expend one of your Hit Point Dice, roll the die, and regain a number of Hit Points equal to the roll plus your Constitution modifier.
...
**Linguistic Mastery.** You learn three languages of your choice and gain proficiency with calligrapher's supplies. You learn languages at half the normal time and speak all known languages and dialects with a native-like accent. Spending time reading or listening to a language counts as time training to learn it.

**Cryptic Insight.** You have advantage on any ability check related to obscure languages, ciphers, handwriting, and any other language or writing-related checks.

**Cipher Creation.** You can ably create written ciphers. Others cannot decipher a code you create unless you teach it to them, they succeed on an Intelligence check (DC = your Intelligence score + your proficiency bonus), or they use magic to decipher it.

**Language of Magic.** When you take this feat, chose a Level 1 spell from any spell list that requires an Action to cast. When you finish a long rest, you can create a spell scroll containing that Level 1 spell. The scroll remains intact until you finish a long rest or until used. The DC of the spell scroll equals 8 + your proficiency bonus + your Intelligence modifier and its spell Attack modifier is 8 + your Intelligence modifier.

### Love Bites

You have learned to twist charm and pain together, enthralling those you strike with both affection and danger.

You gain the following benefits.

**Ability Score Increase.** Increase one ability score of your choice by 1, to a maximum of 20.

**Endearing Pain.** Immediately after you damage a creature with a Melee weapon or an Unarmed Strike, you can take a Bonus Action to give the target the Charmed condition until the end of your next turn or until you or your allies damage it.  
You can use this feature a number of times equal to your Proficiency Bonus, and you regain all expended uses when you finish a Long Rest.
...
**Pure Luck.** When you roll a d20 for a D20 Test, you can spend 1 Luck Point to reroll the die before the outcome is determined. You choose which of the d20s is used for the D20 Test.

**Lucky Dodge.** When a creature rolls a d20 for an attack roll against you, you can spend 1 Luck Point to roll a d20. You then choose whether the attack uses the attacker's roll or yours.
...
**Opportunity Spellbreaker.** When you can see or hear a creature within the reach of a melee weapon you are wielding or your unarmed strikes cast a spell, you can make an opportunity attack against it. On a hit, the creature must succeed on a Constitution saving throw as if it were doing so to maintain concentration. On a failure, its spell fails to take effect, but the spell slot is not expended.

**Concentration Breaker.** When you damage a creature that is concentrating on a spell, that creature has disadvantage on the Constitution saving throw it makes to maintain its concentration.
...
**Unarmored Defense.** So long as you aren't wearing armor or a shield, your Armor Class equals 13 + your Dexterity modifier.

**Agile Strikes.** You can use Dexterity, instead of Strength, for the attack rolls of unarmed strikes. Your unarmed strikes deal bludgeoning damage equal to 1d4 + your Strength or Dexterity modifier on hit.

**Bonus Strike.** When you take the Attack action on your turn and only make unarmed strikes, you can make a single unarmed strike as a bonus action on that same turn.
\page
{{pageNumber,auto}}
### Martial Adept
***Prerequisite: Proficiency with all simple and martial weapons***  

You have studied combat techniques which allow you to perform Martial Exploits. You gain the following benefits:

**Ability Score Increase.** Increase your Strength or Dexterity by 1, to a maximum of 20.

**Martial Exploits.** You learn two 1st-degree Martial Exploits of your choice from those available to the Fighter. If an Exploit requires the target to make a saving throw to resist the effects, the DC is equal to 8 + your proficiency bonus + your Strength or Dexterity modifier (your choice).

**Exploit Change.** Each time you gain a level, you can replace one Exploit you know with another 1st-degree Exploit of your choice.

**Exploit Dice.** You gain two d4 Exploit Dice to fuel your Exploits. An Exploit Die is expended when you use it. You regain all of your Exploit Dice when you finish a short or long rest. If you already have Exploit Dice from another source, you only gain one Exploit Die equal to your other Exploit Dice.
...
**Skill Proficiency.** You gain proficiency in two of the following skills: Arcana, History, Investigation, Medicine, Nature, or Religion.

**Enhanced Expertise.** Choose any two skills from the list above. Whenever you make an ability check with either of the chosen skills, you can treat a roll of 7 or lower on the d20 as an 8.
...
**Metamagic Mastery.** You learn two Metamagic options of your choice from the sorcerer class. You can use only one Metamagic option on a spell when you cast it, unless the option says otherwise. Whenever you reach a level that grants the Ability Score Improvement feature, you can replace one of these Metamagic options with another one from the sorcerer class.

**Sorcery Points.** You gain a number of sorcery points equal to your proficiency bonus to spend on Metamagic (these points are added to any sorcery points you have from another source). You regain all spent sorcery points when you finish a long rest.
\column
### Mobile
...
### Moderately Armored
***Prerequisites: Light Armor Training***  
You have trained to master the use of armor and shields, gaining the following benefits:  
...
**Identification.** You can cast the identify spell without expending a spell slot or material components. You must finish a long rest before you can do so again.  
\page
{{pageNumber,auto}}
...
**Technique Mastery.** You learn two Techniques from the Monk class. If the Technique has a prerequisite, you can learn it only if you are a Monk and you meet its prerequisites. If a Technique requires the target to make a saving throw to resist its effects, the DC equals 8 + your proficiency bonus + your Wisdom modifier. If a Technique mentions a Martial Arts die, that is a d4 for you. If it mentions a Martial Arts attack, those are unarmed strikes, and any attacks with melee weapons that lack heavy or special properties.  

**Ki Points.** You gain 2 Ki Points to spend on Techniques. You regain all of your expended Ki Points when you finish a short or long rest. If you have Ki from another feature, these Ki Points are added to your total pool of Ki Points.

### Mythal-Touched
Your body and soul have been permanently altered by ancient, reality-shaping magic.

**Ability Score Increase.** Increase your Intelligence, Wisdom, or Charisma by 1, to a maximum of 20.

**Mythal Ward.** When you are hit by a spell attack or fail a saving throw against a spell or magical effect, you can use your reaction to invoke the lingering magic within you. Choose one of the following effects:

- **Spell Deflection.** You gain advantage on the saving throw, potentially turning the failure into a success, or you gain a +5 bonus to AC against the triggering spell attack, potentially causing it to miss.
- **Arcane Dampening.** You gain resistance to the damage dealt by the triggering spell or magical effect until the end of the current turn.
- **Spell Reversal.** If the triggering spell or magical effect targets only you, the caster must succeed on a saving throw using the spell’s original save DC or suffer disadvantage on the next attack roll or saving throw they make before the end of their next turn.

You can use this reaction a number of times equal to your proficiency bonus, and you regain all expended uses when you finish a long rest.

**Mythal Resonance.** Whenever you successfully negate or reduce the effect of a spell using your Mythal Ward, you gain temporary hit points equal to your proficiency bonus + the ability modifier increased by this feat.
\column
### Natural Magnetism
Something about your personality and bearing makes others want to be near you. 

**Ability Score Increase.** Increase your Wisdom by 1, to a maximum of 20.

**Polished Personality.** You gain the benefits on the table below that correspond to your Charisma modifier and lower.
...
**Enhanced Strength Checks.** Whenever you make a Strength-based ability check, you can treat a roll of 7 or lower on the d20 as an 8.  

**Mighty Presence.** You count as one size larger for the purposes of your carrying capacity, the weight that you can push, pull, lift, or drag, and for the size of creatures that you can attempt to grapple.  
...
**Puncture.** Once per turn, when you hit a creature with an attack that deals Piercing damage, it takes additional piercing damage equal to the ability modifier used for the attack at the start of your next turn. 
...
**Potent Poison.** When you make a damage roll that deals Poison damage, it ignores Resistance to Poison damage and treats immunity to poison damage as resistance.

**Brew Poison.** You gain proficiency with the Poisoner's Kit. With 1 hour of work as part of a long rest, you can create a number of poison doses equal to your Proficiency Bonus. As a Bonus Action, you can apply a poison dose to a weapon or piece of ammunition. Once applied, the poison retains its potency for 1 minute or until you hit with the poisoned item, whichever is shorter. When a creature takes damage from the poisoned item, that creature must succeed on a Constitution saving throw (DC 8 plus the modifier of the ability increased by this feat and your Proficiency Bonus) or take 1d8 Poison damage and have the Poisoned condition until the end of your next turn.
When you use this feature to create poison, you can expend up 10 gold pieces per dose of poison to create a more deadly poison. When you do so, creatures that fail their Constitution saving throw against it take an additional 1d8 poison damage. 
...
You have mastered the art of spreading decay, inflicting both necrotic damage and lingering weakness upon your foes.

You gain the following benefits.

**Ability Score Increase.** Increase one ability score of your choice by 1, to a maximum of 20.

**Necrosis.** When you make a damage roll that deals Necrotic damage, you can cause one creature taking that damage to have the Poisoned condition until the end of your next turn.  
You can use this feature a number of times equal to your Proficiency Bonus, and you regain all expended uses when you finish a Long Rest.

### Rebuke

You wield the power of radiant energy to strike down your foes, leaving them unbalanced and vulnerable.
...
**Resilient Recovery.** When you are successfully stabilized while dying, you regain hit points equal to your Constitution modifier (minimum of 1).

**Fortifying Healing.** Whenever you regain hit points, except by the effects of this feat, you regain additional hit points equal to your Constitution modifier (minimum of 1).
...
**Defensive Stance.** While you are holding a double-bladed scimitar with two hands, you gain a +1 bonus to Armor Class.

**Agile Wielder.** A double-bladed scimitar has the finesse property when you wield it.
...
**Thieves' Cant.** You learn to speak, read, write, and decode Thieves' Cant.
...
**Savage Exploits.** You learn two 1st-degree Savage Exploits of your choice from those available to the Barbarian. If an Exploit you use requires the target to make a saving throw to resist the effects, the DC is equal to 8 + your proficiency bonus + your Strength or Dexterity modifier (your choice).

**Exploit Change.** Each time you gain a level, you can replace one of the Exploits you know with a 1st-degree Savage Exploit of your choice.

**Exploit Dice.** You gain two d4 Exploit Dice to fuel your Exploits. An Exploit Die is expended when you use it. You regain all of your expended Exploit Dice when you finish a short or long rest. If you already have or gain any Exploit Dice from another source, you only gain one Exploit Die equal to your other Exploit Dice.
...
**Mastery of Scholarship.** You master a Scholarly Pursuit of your choice from those available to the Savant. If the Pursuit has a Savant level prerequisite, you can learn it if your total level meets or exceeds the prerequisite level for that Scholarly Pursuit.
...
**Planar Connection.** Choose a type of plane listed in the Planar Infusion table. Your choice gives you resistance to a damage type and the ability to cast a cantrip, as specified in the table. You can cast this cantrip without material components, and your spellcasting ability for it is Intelligence, Wisdom, or Charisma (choose when you select this feat).
...
Whenever you cast *Hex*, taking damage does not break your concentration on the spell.

**Curse Magic.** When a creature that you've cursed with *Hex* damages you, the creature takes Psychic damage equal to your Proficiency Bonus.
...
You have trained extensively with ranged weapons to become a master marksman. You gain the following benefits:

**Ability Score Increase.** Increase your Dexterity score by 1, to a maximum of 20.

**Bypass Cover.** Your attacks with ranged weapons can ignore Half-Cover, and treat Three-Quarters Cover as Half-Cover.

**Long Shots.** Attacking at long range doesn't impose Disadvantage on your attack rolls with Ranged weapons.

**Precise Aim.** You can use a bonus action to give yourself advantage on your next ranged weapon attack roll on your current turn.
...
**Skill Proficiency.** You gain proficiency in any three skills of your choice.
...
**Casting in Melee.** Being within 5 feet of an enemy doesn't impose Disadvantage on your ranged spell Attack Rolls.

**Increased Range.** When you cast a spell or use an ability that has a range of at least 10 feet and requires you to make a spell attack roll, you can increase the spell's or ability's range by 60 feet.
...
**Ability Score Increase.** Increase your Strength, Dexterity, or Intelligence score by 1, up to a maximum of 20.

**Cantrips.** You learn two Cantrips of your choice from the Magus spell list, choosing Intelligence, Wisdom, or Charisma as your spellcasting ability for these Magus Cantrips. At least one of these Cantrips must deal damage.
...
**Conjure Spirits.** You learn the *Mage Hand* and *Seance* Cantrips.
...
Your training in the ways of the Knights grants you these benefits:
...
You have a gift for identifying weaknesses and assessing the battlefield.

**Ability Score Increase.** Increase your Intelligence or Wisdom score by 1, up to a maximum of 20.

**Tactical Assessment.** When you take the Search action, you can target a creature you can see within 30 feet (DC = 8 + its Challenge Rating). If you can observe the creature for at least 1 minute, add your level to the roll.

On a success, you learn one characteristic of your choice from the following:
{{column-count:1
|||
|:----------------:|:--:|
| Armor Class       | Lowest Ability Score  |
| Highest Ability Score            | Resistances |
| Immunities          | One Feature or Trait |

}}

Once you use this feature on a creature, you cannot target it again until you finish a long rest.

### Street Justice
You are skilled in subduing foes and turning their struggles to your advantage, whether through physical control or sheer intimidation.
...
You are quick to exploit openings and look out for your allies, turning opportunity into advantage in the heat of combat.
...
**Ability Score Increase.** Increase your Strength, Constitution or Wisdom by 1, up to a maximum of 20.

**Giant Strike.** When you take this feat, choose one of the benefits listed below. Once per turn, when you hit a target with a melee weapon attack or a ranged weapon attack using a thrown weapon, you can imbue the attack with an additional effect depending on the benefit you chose:  
...
**Ability Score Increase.** Increase your Strength, Dexterity, Constitution or Wisdom by 1, to a maximum of 20.
...
**Repeatable.** You can choose this feat multiple times. Each time you do, raise one of the ability scores above by 1, and learn one new Tactical Exploit from the list above.
...
**Enhanced Throwing.** Simple and martial melee weapons without the thrown property have the thrown property for you. One-handed weapons have a normal range of 20 feet and a long range of 60 feet, while two-handed weapons have a normal range of 15 feet and a long range of 30 feet.

**Improved Ranges.** Weapons that already have the thrown property increase their short range by 20 feet and their long range by 40 feet for you.

**Boomerang Return.** When you attack with a thrown weapon attack using a light weapon, the weapon returns to your grasp like a boomerang at the end of your turn, unless something prevents it from returning. You can catch and stow as many weapons as you threw in this way.

### Tireless Reveler

Your infectious energy and unshakable spirit turn every victory into a celebration, and every setback into an excuse to rally onward.

**Ability Score Increase.** Increase your Constitution or Charisma by 1, to a maximum of 20.

**Shared Inspiration.** When an ally you can see within 60 feet of you expends Heroic Inspiration, you can gain Heroic Inspiration if you don’t already have it.

You can use this benefit a number of times equal to your Proficiency Bonus, and you regain all expended uses when you finish a Short or Long rest.
...
You have learned to manipulate hearts and minds, bending others to your will while striking decisively against those under your charm.
...
Through grim experience and relentless training, you have learned how to break free of the undead’s grasp and endure the draining touch of necromantic power.

You gain the following benefits.

**Ability Score Increase.** Increase your Constitution, Dexterity, or Wisdom by 1, to a maximum of 20.

**Adroit Escape.** You have Advantage on ability checks and saving throws against nonmagical restraints and the Grappled condition.

**Unyielding Will.** You have Advantage on saving throws against being Charmed. Additionally, you can't be possessed or have your Hit Point maximum reduced.

**Vitality Ward.** When you take Necrotic damage, you can mitigate the damage. Roll a number of d6s equal to your Proficiency Bonus, and add them together. Reduce the Necrotic damage you take by this total.  
You can use this benefit a number of times equal to your Proficiency Bonus, and you regain all expended uses when you finish a Long Rest.

### Vampire's Plaything

You bear the lingering connection to a vampire who once held power over you, granting uncanny versatility and a link to otherworldly insight.
...
**Hemocraft Secrets.** As a bonus action, you can choose to take 1d6 necrotic damage to gain a blood boon. Your blood boon lasts for 1 hour or until expended. The damage you take to gain a blood boon can't be reduced in any way. You can only have one blood boon at a time. 

**Bonus Attack Roll.** When you make an attack roll, you can expend one blood boon to roll 1d6 and add it to the total.

**Necrotic Surge.** When you hit with an attack or spell, you can expend one blood boon to deal an additional 2d6 necrotic damage.

**Debilitating Save.** When you cause a creature to make a Strength, Dexterity, or Constitution saving throw, you can expend one blood boon to roll a d4 and reduce their save by the amount rolled.
...
**Resolute Focus.** Whenever you are forced to make a saving throw to maintain concentration on a spell, you can make your saving throw using your Spellcasting Ability instead of Constitution.

**Reactive Spell.** When a creature provokes an Opportunity Attack from you by leaving your reach, you can take a Reaction to cast a spell at the creature rather than making an Opportunity Attack. The spell must have a casting time of one action and must target only that creature. Additionally, when you hit a creature with an opportunity attack, you can cast a spell with a casting time of On Hit.
...
**Weapon Mastery.** Your training with weapons allows you to use the mastery property of one kind of Simple or Martial weapon of your choice. Whenever you finish a Long Rest, you can change the kind of weapon to another eligible kind.
...
**Primal Bond.** You have forged a bond with an animal companion that will adventure by your side. Choose a beast of CR 1/8 or lower to be your Wild Companion. This Companion is friendly to you, and it obeys your commands to the best of its abilities.
...
**Exploits Known.** You learn two 1st-degree Cunning Exploits from those available to the Wanderer. If an Exploit requires a saving throw, its save DC equals **8 + your Proficiency Bonus + your Strength or Dexterity modifier** (your choice when you select this feat).

**Retraining Exploits.** Whenever you gain a level, you can replace one of the Cunning Exploits you learned through this feat with another 1st-degree Cunning Exploit of your choice.
...
**Life Lessons.** You gain the benefits on the table below that correspond to your current Wisdom modifier and lower. Should your Wisdom modifier increase, the benefits that you gain from this Feat also increase with your modifier.

| Modifier |                     Benefit Description                                                                                       |
|----------|---------------------------------------------------------------------------------------------------------------------------------------------|
| +1       | **Master's Proficiency.** You gain proficiency with one set of artisan's tools of your choice.                                          |
| +2       | **Persuasive Wisdom.** You can make Wisdom (Persuasion) checks in place of Charisma (Persuasion) checks.                        |
| +3       | **Insights of the Wise.** You gain proficiency in either Animal Handling, Insight, Medicine, or Perception.                        |
| +4       | **Sage's Foresight.** When you make a Wisdom (Insight) check, you treat a d20 roll of 7 or lower as an 8.                         |
| +5       | **Clarity of the Wise.** You have advantage on saving throws to resist enchantment and illusion spells. |
...
Advanced feats represent advanced training and exceptional abilities that characters develop through experience and practice. These feats have a prerequisite of Level 4 or higher and can be selected whenever your class grants you the Ability Score Improvement feature.  
...
### Adept of the Black Magic
***Prerequisites: Level 4+, initiate of high sorcery (black magic) feat***  
You have studied deeply the ways of Black Magic, gaining the following benefits:  
...
### Adept of Red Magic
***Prerequisites: Level 4+, initiate of high sorcery (red magic) feat***   
You have studied deeply the ways of Red Magic, gaining the following benefits: 
...
\column
### Adept of White Magic
***Prerequisites: Level 4+, initiate of high sorcery (white magic) feat***  
You have studied deeply the ways of White Magic, gaining the following benefits: 
...
### Baleful Scion
***Prerequisites: Level 4+, scion of the outer planes (evil outer plane) feat***  
...
***Prerequisites: Level 4+, Tactical Lieutenant or Martial Weapon Proficiency***

You inspire courage on the battlefield, bolstering allies and striking fiercely when under pressure.
...
### Champion's Resolve
***Prerequisites: Level 4+, Knightly Champion***

Your unwavering presence inspires allies, helping them stand strong in the face of danger.

You gain the following benefits.

**Ability Score Increase.** Increase your Strength or Charisma by 1, to a maximum of 20.

**Standard Bearer.** As a Bonus Action, choose a number of creatures up to your Proficiency Bonus within 60 feet of yourself that can see you. Each target can immediately take a Reaction to right itself and end the Prone condition, provided its Speed isn't 0. Additionally, you bolster the targets' resolve, which lasts for 1 minute or until you have the Incapacitated condition. While bolstered, a target can't be possessed or gain the Charmed or Frightened condition; if a target is already possessed, Charmed, or Frightened, the target has Advantage on any new saving throw against the relevant effect.

Once you use this benefit, you can't do so again until you finish a Short or Long Rest.
### Cohort of Chaos
***Prerequisites: Level 4+, scion of the outer planes (chaotic outer plane) feat*** 
...
### Dragonscarred
***Prerequisites: Level 4+, Dragon Initiate***

The draconic power within you leaves its mark on your body and strikes fear into those who oppose you.
...
***Prerequisites: Level 4+, strike of the giants (cloud strike) feat***
...
### Knight of the Crown
***Prerequisites: Level 4+, squire feat***

As a Knight, you extol the virtues of cooperation, loyalty, and obedience. You excel in group combat and gain these benefits:
...
As a Knight, you are known for leadership, justice, and wisdom. Your resolve grants you these benefits:
...
As a Knight, you are devoted to heroism and courage. Bravery steels your spirit, granting you these benefits:
...
### Magebane Resolve
***Prerequisites: Level 4+, mage slayer feat***

Your mental fortitude strengthens as you battle spellcasters, allowing you to shrug off their arcane influence.
...
**Close-Quarters Spell Resistance.** You have advantage on saving throws against spells cast by creatures you can see or hear within 5 feet of you.



### Nature's Bond
***Prerequisites: Level 4+, Ward of the Wilds***

You have deepened your connection with the natural world, attuning yourself to beasts and sharing their senses.
...
### Planar Wanderer
***Prerequisites: Level 4+, scion of the outer planes feat***
...
### Righteous Heritor
***Prerequisites: Level 4+, scion of the outer planes (good outer plane) feat***
...
### Ritual Master
***Prerequisite: Level 4+, Ritual Caster feat***

You have mastered ritual magic, granting you the following benefits:

**Ability Score Increase.** Increase your Intelligence, Wisdom, or Charisma score by 1, to a maximum of 20.

**Ritual Book.** When you choose this feat, you acquire a ritual book. You can cast any spell contained in this ritual book as a ritual only, unless you know the spell through other means. If you come across a spell in written form, such as a magical spell scroll or a wizard's spellbook, you might be able to add it to your ritual book. The spell's level can be no higher than half your level (rounded up), and it must have the ritual tag. The process of copying the spell into your ritual book takes 2 hours per level of the spell. The spells' spellcasting ability is the ability increased by the *Ritual Caster* feat.



### Signature Technique
***Prerequisite: Level 4+, At least one Exploit Known***

You have practiced and mastered a single technique so you can use it at will.
...
### Spelldriver
***Prerequisites: Level 8+; Spellcasting or Pact Magic feature***
...
You have mastered the art of channeling your inner fire, making your spells burn brighter and hit harder.

You gain the following benefits.

**Ability Score Increase.** Increase your Intelligence, Wisdom, or Charisma by 1, to a maximum of 20.

**Fueled Spellfire.** Once per turn, when a spell you cast deals Radiant damage, you can expend up to a number of Hit Point Dice equal to your Proficiency Bonus, roll them, and add the total rolled to one damage roll of the spell.

**Searing Spellfire.** When you make a damage roll that deals Radiant damage, it ignores Resistance to Radiant damage. Additionally, once per turn, the damage ignores Immunity to Radiant damage for one target of your choice.


### Streetwise Tactician
***Prerequisites: Level 4+, Streetwise Fighter***

You fight with cunning and precision, turning enemy attacks into opportunities and honing your skills for maximum effect.
...
You have mastered the art of teamwork, weaving your cunning and presence to protect and empower your allies.
...
**Inspiring Willpower.** If you succeed on a saving throw to end the Frightened, Paralyzed, or Restrained condition on yourself, you can choose one ally you can see within 30 feet of yourself that has the same condition. That condition immediately ends for that ally.

### Unyielding Unity
***Prerequisites: Level 4+, Guardian Initiate***

You and your allies stand firm, bolstering each other's strength and maintaining your footing in the heat of battle.
...
**Stronger Together.** If you are within 5 feet of an ally that doesn't have the Incapacitated condition, you and that ally have Advantage on Strength saving throws and Strength-based ability checks. You can't use this benefit while you have the Incapacitated condition.
 
### Vigor of the Hill Giant
***Prerequisites: Level 4+, strike of the giants (hill strike) feat***
...
## Epic Boons
Epic boons are extraordinary supernatural gifts reserved for the most legendary heroes who have reached the pinnacle of mortal power. These powerful boons have a prerequisite of 19th level or higher and represent capabilities that transcend normal adventuring prowess, reflecting your character's ascension toward mythic status. Epic boons can be selected in place of an Ability Score Improvement when your class grants you that feature at these highest levels, providing transformative abilities that befit characters approaching the end of their mortal journeys.

### Boon of Ascendant Magic
...
**Ascendant Magic.** Choose a level 8 or lower spell from the Sorcerer spell list or a spell from the Ascendant Spellmark Spells table (the table includes spellmark suggestions if you'd like to associate a spell with one of the marks). You always have that spell prepared. You can cast it once at level 8 without a spell slot or spell components, and you regain the ability to cast it in that way when you finish a Short or Long Rest. You can also cast this spell using any spell slots you have of the appropriate level. Intelligence, Wisdom, or Charisma is your spellcasting ability for this spell (choose when you gain this feat).

#### Ascendant Spellmark Spells
| Spell | Suggested Spellmark |
|:------|:--------------------|
...
You are imbued with the raw power of the sun, radiating light and burning your foes with every strike.
...
You thrive in carnage, drawing strength and precision from the brink of death.
...
You have perfected your resilience, turning even fleeting vitality into enduring strength.

You gain the following benefits.

**Ability Score Increase.** Increase one ability score of your choice by 1, to a maximum of 30.

**Augmented Health.** When you gain Temporary Hit Points, increase the number of Temporary Hit Points you gain by 10.
...
Your mind and words carry exceptional clarity, allowing you to influence, understand, and communicate with others with uncanny precision.
...
Your body and mind steel themselves in the face of mortal peril, shrugging off blows that would fell lesser beings.

You gain the following benefits.

**Ability Score Increase.** Increase your Strength or Constitution by 1, to a maximum of 30.

**Defense of Body and Mind.** While you are Bloodied, you have Resistance to all damage types except Force.
\page
{{pageNumber,auto}}
...
You are imbued with divine brilliance, ensuring your radiance purges the unworthy and empowers your attacks.
...
**Powerful Radiance.** When you make a damage roll that deals Radiant damage, you can instead use the highest number possible for each damage die.  
...
You have mastered the art of transformation, shifting your form at will and gaining resilience in the process.
...
**Hardy Transformation.** When you gain Temporary Hit Points from shape-shifting, increase that number of Temporary Hit Points by 20.
...
Luck bends to your will, giving you a second chance when fate turns against you.
...
You have mastered the art of shadows, extending your reach and moving with uncanny agility in the darkness.
...
You have learned to slip from mortal danger like mist, escaping certain death with ethereal grace.

You gain the following benefits.

**Ability Score Increase.** Increase your Intelligence, Wisdom, or Charisma by 1, to a maximum of 30.

**Gaseous Form.** If you drop to 0 Hit Points but aren't killed outright, you can instead drop to 1 Hit Point, teleport to an unoccupied space within 30 feet of you and cast *Gaseous Form* on yourself without expending a spell slot (no action required). When you cast this spell this way, you can target only yourself, your Fly Speed is 30 feet, and you regain 10 Hit Points at the start of each of your turns for the spell's duration. You need not keep concentration on this spell, and it lasts for its full duration or until you take a Magic action to end it.
The spellcasting ability for the spell is the ability increased by this feat.  
Once you use this benefit, you can't do so again until you finish a Long Rest.

### Boon of Poison Mastery
***Prerequisite: Level 19+***

Your mastery over toxins is unparalleled, allowing you to resist and wield poisons with deadly precision.
...
Your presence inspires celebration and chaos alike, compelling foes and allies to join in your enchanting performance.

You gain the following benefits.

**Ability Score Increase.** Increase your Intelligence, Wisdom, or Charisma by 1, to a maximum of 30.

**Inspire Dance.** You always have the *Irresistible Dance* spell prepared. You can cast it once without a spell slot at 6th level, and you regain the ability to cast it that way when you finish a Long Rest. You can also cast the spell using any spell slots you have of the appropriate level.  
When you cast the spell, it requires no spell components, and you can target one additional creature of your choice. Taking damage doesn't break your Concentration on it.
...
The radiance of the sun flows through you, shielding your allies and banishing darkness wherever you go.
...
You command the fury of the storm itself, unleashing lightning and thunder while shielding yourself in its power.
...
You draw vitality from the fallen, feeding your own life force with the demise of your enemies.
...
**Siphon Life.** When an enemy within 120 feet of you is reduced to 0 Hit Points, you can take a Reaction to regain 50 Hit Points. That creature can also not be restored to life while you are alive. Once you use this benefit, you can't use it again until you finish a Short or Long Rest.
...
## Species Feats
Species feats are feats tied to your character's biology, culture, or heritage, and have a specific race or species as a prerequisite. These feats represent specialized abilities or training that members of your race are particularly suited to develop. Racial feats that have no level requirement can be selected at 1st level as origin feats (though you do not gain any Ability Score Improvements when taking them this way), while those with level prerequisites of Level 4+ or higher must be selected when your class grants you the Ability Score Improvement feature. This allows you to immediately explore aspects of your heritage at character creation or develop more advanced racial abilities as you gain experience.

### Aarakocra Magic
***Prerequisite: Aarakocra (Wind Caller)***

You learn the magic of the winds and skies, which are revered and protected by your people. You gain the following benefits:

**Ability Score Increase.** Increase your Intelligence, Wisdom or Charisma by 1, to a maximum of 20.

**Wind Magic.** You learn the *Gust* cantrip. You also learn the *Wind Wall* spell, which you can cast once without expending a spell slot. You regain the ability to cast this spell in this way when you finish a long rest. You can also cast it using any spell slots you have. Intelligence, Wisdom or Charisma is your spellcasting ability for those spells (your choice when you gain this feat).

### Angelic Wings
***Prerequisite: Aasimar (Any trait), Level 8+***

You gain the following benefits:

**Ability Score Increase.** Increase your Dexterity, Constitution, or Charisma by 1, to a maximum of 20.

**Wings.** You sprout bird-like wings from your shoulder blades. You have a flying speed of 30 feet while you aren't wearing medium or heavy armor. If you have a racial ability that would give you a flying speed, it instead increases your flying speed by that amount.

### Bountiful Luck
***Prerequisite: Halfling (Lucky)***  
Your people have extraordinary luck, which you have learned to mystically lend to your companions when you see them falter. You're not sure how you do it; you just wish it, and it happens. Surely a sign of fortune's favor! 
You gain the following benefits:

**Ability Score Increase.** Increase your Dexterity or Charisma by 1, to a maximum of 20.

**Shared Luck.** When an ally you can see within 30 feet of you rolls a 1 on the d20 for an attack roll, an ability check, or a saving throw, you can use your reaction to let the ally reroll the die. The ally must use the new roll.

**Lucky Cooldown.** When you use this ability, you can't use your Lucky racial trait before the end of your next turn.


### Celestial Awakening
***Prerequisite: Aasimar (Celestial Revelation)***

You Celestial Powers have reached their pinnacle. You gain the following benefits:

**Ability Score Increase.** Increase your Constitution, Wisdom, or Charisma score by 1, to a maximum of 20.

**Enhanced Celestial Powers.** You can use your *Radiant Consumption*, *Radiant Soul*, or *Necrotic Shroud* abilities a number of times equal to your proficiency bonus. You regain all expended uses when you finish a long rest.
 
\column
### Changeling Metamorphosis
***Prerequisite: Changeling (Shapechanger)***

Your ability to shapechange is more than skin deep. You gain the following benefits:

**Ability Score Increase.** Increase your Constitution score by 1, to a maximum of 20.

**Enhanced Shapechanging.** When you use your Shapechanging trait, you can choose one of the following benefits, which lasts until you use your Shapechanging trait again. Some of these benefits require specific physical features, such as gills or claws, that can be seen by observers.
...
### Demonic Wings
***Prerequisite: Tiefling (Any trait), Level 8+*** 

You gain the following benefits:

**Ability Score Increase.** Increase your Strength, Constitution, or Charisma by 1, to a maximum of 20.

**Demon Wings.** You manifest leathery wings from your shoulder blades. You have a flying speed of 30 feet while you aren't wearing medium or heavy armor.

### Divine Power
***Prerequisite: Aasimar (Any trait)*** 

You gain the following benefits:

**Ability Score Increase.** Increase your Intelligence, Wisdom, or Charisma by 1, to a maximum of 20.

**Divine Magic.** You harness the divine magic that runs through your blood. You gain the following magical abilities:

- **At-Will Detection.** You learn the *Detect Evil and Good* spell and can cast it at will, without expending a spell slot.

- **Divine Spell.** You learn the *Lesser Restoration* spell, which you can cast once without expending a spell slot. You regain the ability to cast this spell in this way when you finish a long rest. You can also cast it using any spell slots you have.
...
### Draconic Wings
***Prerequisite: Kobold or Dragonborn (Any trait), Level 8+***

You gain the following benefits:

**Ability Score Increase.** Increase your Strength, Constitution, or Charisma by 1, to a maximum of 20.

**Draconic Wings.** Your draconic bloodline manifests in the form of leathery wings. You have a flying speed of 30 feet while you aren't wearing medium or heavy armor.
...
### Dragon Fear
***Prerequisite: Dragonborn (Breath Weapon)***   

You gain the following benefits:

**Ability Score Increase.** Increase your Strength, Constitution, or Charisma by 1, to a maximum of 20.

**Menacing Roar.** When angered, you radiate menace. Instead of exhaling destructive energy, you can expend a use of your Breath Weapon trait to roar, forcing each creature of your choice within 30 feet of you to make a Wisdom saving throw (DC 8 + your proficiency bonus + your Charisma modifier). A target automatically succeeds on the save if it can't hear or see you. On a failed save, a target becomes frightened of you for 1 minute. If the frightened target takes any damage, it can repeat the saving throw, ending the effect on itself on a success.

**Additional Uses.** You can use your Breath Weapon two additional times per long rest.

### Dragon Hide 
***Prerequisite: Dragonborn (Any trait)***   
You manifest scales and claws reminiscent of your draconic ancestors. Your draconic heritage intensifies, granting you the following benefits:

**Ability Score Increase.** Increase your Strength, Constitution, or Charisma by 1, to a maximum of 20.

**Adamantine Scales.** Your scales harden to an almost metallic consistency. While you aren't wearing armor, you can calculate your AC as 13 + your Dexterity modifier. You can use a shield and still gain this benefit.

**Retractable Talons.** You develop deadly, retractable claws. As a bonus action, you can extend or retract these natural weapons. While extended, your unarmed strikes deal 1d6 + your Strength modifier slashing damage instead of the normal bludgeoning damage. You are proficient with these natural weapons.

**Draconic Resilience.** Your hit point maximum increases by an amount equal to your level when you gain this feat. Whenever you gain a level thereafter, your hit point maximum increases by an additional 1 hit point.

### Drow High Magic
***Prerequisites: Elf (Drow Magic)***   
You gain the following benefits:

**Ability Score Increase.** Increase your Intelligence, Wisdom, or Charisma by 1, to a maximum of 20.

**Drow High Magic.** You learn more of the magic typical of dark elves. You gain the following magical abilities:

- **Constant Vigilance.** You learn the *detect magic* spell and can cast it at will, without expending a spell slot.

- **Drow Spellcasting.** You learn *levitate*, which you can cast once without expending a spell slot. You regain the ability to cast this spell in this way when you finish a long rest. You can also cast it using any spell slots you have.

- **Spellcasting Ability.** Intelligence, Wisdom, or Charisma (your choice when you gain this feat) is your spellcasting ability for both spells.


### Dwarven Fortitude 
***Prerequisite: Dwarf (Any trait)***

You have the blood of dwarf heroes flowing through your veins. You gain the following benefits:

**Ability Score Increase.** Increase your Constitution score by 1, to a maximum of 20.

**Dwarven Fortitude.** Whenever you take the Dodge action in combat, you gain a number of temporary hit points equal to one roll of your Hit Die + your Constitution modifier (minimum of 1).

### Elemental Tempest 
***Prerequisite: Genasi (All traits from one subrace)***

You become an elemental tempest, a genasi capable of manifesting two elemental forms simultaneously. You gain the following benefits:

**Ability Score Increase.** Increase your Constitution or Charisma by 1, to a maximum of 20.

**Dual Elemental Manifestation.** Unlike most genasi, who typically have a single, dominant elemental manifestation, you have two elemental manifestations. This choice grants you the traits of a genasi subrace other than yours.

**Elemental Versatility.** You can switch between your two elemental manifestations as a bonus action on your turn. Each manifestation grants you access to its unique racial traits and abilities.


### Elven Accuracy
***Prerequisite: Elf (Keen Senses)***
...
**Accuracy.** Whenever you have advantage on an attack roll using Dexterity, Intelligence, Wisdom, or Charisma, you can reroll one of the dice once.

### Envoy Specialist
***Prerequisite: Warforged (Any trait)***  
...
**Integrated Tool.** Choose one of these tools you are proficient with that weighs 10 pounds or less: an artisan's tool, forgery kit, herbalism kit, poisoner's kit, thieves' tools, or a musical instrument. You have a working model of this tool integrated into your body. It can't be removed, and as long as you have a hand free, you can make use of the integrated tool.

**Enhanced Proficiency.** Your proficiency bonus is doubled when you make ability checks using this integrated tool.

### Fade Away
***Prerequisite: Gnome (Any trait)***    
Your people are clever, with a knack for illusion magic. You have learned a magical trick for fading away when you suffer harm. You gain the following benefits:

**Ability Score Increase.** Increase your Dexterity or Intelligence by 1, to a maximum of 20.

**Vanish.** Immediately after you take damage, you can use a reaction to teleport 10 feet and magically become invisible until the end of your next turn or until you attack, deal damage, or force someone to make a saving throw. You can use this ability a number of times equal to your proficiency bonus, and you regain all expended uses when you finish a long rest.
...
### Feline Grace
***Prerequisite: Tabaxi (Feline Agility trait)***  

Your incredible reflexes and agility further improve. You gain the following benefits:

**Ability Score Increase.** Increase your Dexterity score by 1, to a maximum of 20.

**Enhanced Feline Agility.** You can use your Feline Agility trait twice before you must move 0 feet on one of your turns to use the trait again. You can still only use this ability once per turn when you move.

**Cat's Grace.** You don't take damage from falling 20 feet or less if you aren't incapacitated.

### Fey Enchantment
***Prerequisite: Elf (High Elven Magic trait)***

Your study of high elven lore has unlocked fey power that few other elves possess. You gain the following benefits:

**Ability Score Increase.** Increase your Intelligence or Charisma by 1, to a maximum of 20.

**Fey Tongues.** You learn to speak, read, and write Sylvan.

**Fey Charm.** You learn the charm person spell and can cast it at 2nd level without expending a spell slot. You regain the ability to cast this spell in this way when you finish a long rest. You can also cast it using any spell slots you have. Intelligence, Wisdom, or Charisma (your choice when you gain this feat) is your spellcasting ability for this spell.

**Enchanting Presence.** When you cast an enchantment spell of 1st level or higher, you can choose to impose disadvantage on the first saving throw one target makes against the spell. Once you use this feature, you can't use it again until you finish a long rest.

### Firbolg Beast Magic
***Prerequisite: Firbolg (Speech of Beast and Leaf trait)***  

You gain the following benefits:

**Ability Score Increase.** Increase your Intelligence, Wisdom, or Charisma by 1, to a maximum of 20.

**Animal Affinity.** Your connection to animals deepens, granting you the following magical abilities:

- **Beast Speech.** You learn the *speak with animals* spell and can cast it at will, without expending a spell slot.

- **Animal Magic.** You learn the *animal friendship* and *beast sense* spells, each of which you can cast once without expending a spell slot. You regain the ability to cast these two spells in this way when you finish a long rest. You can also cast these spells using any spell slots you have.
...
**Flames of Fury.** When you roll fire damage for a spell you cast or an ability you use, you can reroll any roll of 1 on the fire damage dice.

**Fiery Aura.** Whenever you cast a spell or use an ability that deals fire damage, you can cause flames to wreathe you until the end of your next turn. The flames don't harm you or your possessions, and they shed bright light out to 30 feet and dim light for an additional 30 feet. While the flames are present, any creature within 5 feet of you that hits you with a melee attack takes 1d4 fire damage.
\column
 
### Focused Personas
***Prerequisite: Changeling (Shapechanger trait)***  
...
**Persona Expertise (Tool).** Choose a tool and define a persona associated with it. While you are using your Shapechanging trait to assume the identity of that persona, you are proficient with that tool. If you are already proficient in it, your proficiency bonus is doubled for any ability check you make using that tool while assuming that persona.
...
**Environmental Resistance.** You have resistance to cold and poison damage.

**Poison Resilience.** You have advantage on saving throws against being poisoned.

### Juggernaut Plating
***Requirement: Warforged (Any trait)***  

Your armor is a part of you, strengthened by your life force. You gain the following benefits:

**Ability Score Increase.** Increase your Strength or Constitution score by 1, to a maximum of 20.

**Enhanced Integration (Light/Medium).** When you use Integrated Protection to don light or medium armor, you can add your Constitution modifier to your Armor Class instead of your Dexterity modifier (to a maximum of +2 when using medium armor).

**Enhanced Integration (Heavy).** When you use Integrated Protection to don heavy armor, you have advantage on Strength saving throws and Strength (Athletics) checks to resist being knocked prone or moved against your will.
...
You have learned to temporarily mimic even the training
of others. You gain the following benefits:
...
Your ability to shrug off some injuries is legendary, even
for your race. You gain the following benefits:

**Ability Score Increase.** Increase your Strength or Constitution score by 1, to a maximum of 20.

**Enhanced Stone's Endurance.** When you use your Stone's Endurance trait as a reaction to reduce damage, after rolling the d12 and adding your Constitution modifier, you gain resistance to the triggering attack's damage type until the start of your next turn. If the triggering attack deals more than one type of damage, choose one.

### Orcish Fury
***Prerequisite: Orc (Relentless Endurance)***

Your fury burns tirelessly. You gain the following benefits:

**Ability Score Increase.** Increase your Strength or Constitution by 1, to a maximum of 20.

**Savage Attacks.** When you hit with an attack using a simple or martial weapon, you can roll one of the weapon's damage dice an additional time and add it as extra damage of the weapon's damage type. You can use this ability a number of times equal to your proficiency bonus and you regain all expended uses when you finish a long rest.
...
### Prodigy
***Prerequisite: Human (Any trait)*** 

You have a knack for learning new things. You gain the following benefits:

**Ability Score Increase.** Increase one ability score of your choice by 1, to a maximum of 20.

**Skillful.** You gain one skill proficiency of your choice, one tool proficiency of your choice, and fluency in one language of your choice.
...
### Quori Bond
***Prerequisite: Kalashtar (Dual Mind trait)***  

The quori are tied to emotions. The tsucora feed on fear. The hashalaq are master manipulators. The kalaraq are the nobility of nightmares. The du’ulora harness fury. Your bond with your quori spirit is unusually strong, and you can draw on a fraction of its power and instincts. When you choose this feat, choose your quori lineage: hashalaq, du’ulora, kalaraq, or tsucora. You gain the following benefits:

**Ability Score Increase.** Increase your Wisdom or Charisma score by 1, to a maximum of 20.

**Quori Skill Affinity.** Each quori lineage is associated with a particular skill. When you use that skill, you can roll 1d4 and add the number rolled to the ability check.

**Quori Spell.** Each quori lineage is associated with a particular spell. You learn this spell and can cast it at its lowest level. Once you cast it using this feat, you can't do so again until you finish a long rest. Your spellcasting ability for this spell is Wisdom or Charisma, chosen when you select this feat.

| Quori Lineage | Skill | Spell |
|:----:|:-------------|:-------------|
| Du’ulora | Intimidation | *crown of madness*|
| Hashalaq | Persuasion | *suggestion* |
| Kalaraq | Perception | *mind spike (XGE)*|
| Tsucora | Intimidation | *wrathful smite* * |
___
\* *when cast using this feat, deals 3d6 points of psychic damage*

### Second Chance
***Prerequisite: Halfling (Lucky trait)***

Fortune favors you when someone tries to strike you. You gain the following benefits:

**Ability Score Increase.** Increase your Dexterity, Constitution, or Charisma by 1, to a maximum of 20.

**Lucky Defense.** When a creature you can see hits you with an attack roll, you can use your reaction to force that creature to reroll. You can use this ability a number of times equal to your proficiency bonus, and you regain all expended uses when you finish a long rest.

### Sky Warden
***Prerequisite: Aarakocra (Flight trait)***  

You are trained for both scouting the skies and aerial
combat. You gain the following benefits:

**Ability Score Increase.** Increase your Dexterity or Wisdom score by 1, to a maximum of 20.

**Keen Sight.** You gain proficiency in the Perception skill. You add double your proficiency bonus to Perception checks that rely on sight.

**Diving Attack.** Once per turn, if you are flying and dive at least 15 feet straight toward a target and then hit it with a melee weapon attack, the attack deals an extra 1d6 damage to the target.

### Squat Nimbleness
***Prerequisite: Dwarf (Dwarven Resilience trait) or a Small race***
You are uncommonly nimble for your race. You gain the following benefits:

**Ability Score Increase.** Increase your Strength or Dexterity by 1, to a maximum of 20.

**Fleet of Foot.** Increase your walking speed by 5 feet.

**Athletic Prowess.** You gain proficiency in the Acrobatics or Athletics skill (your choice).
...
**Innate Spellcasting.** You can now cast *Nondetection* on yourself at will. You can also cast *blur* once with this ability. You regain the ability to cast this spell when you finish a long rest. You can also cast them using any spell slots you have. Intelligence, Wisdom, or Charisma (your choice when you gain this feat) is your spellcasting ability for both spells.

### Thoughtsinger
***Prerequisite: Kalashtar (Mind Link trait)***
...
**Elemental Mastery.** You master more of the magic of elemental air and water. You gain the following magical abilities:

- **Elemental Cantrip.** You learn the *shape water* or *gust* cantrip (your choice).

- **Elemental Spells.** You learn *warding wind* and *wall of water*, each of which you can cast once without expending a spell slot. You regain the ability to cast these two spells in this way when you finish a long rest. You can also cast these spells using any spell slots you have.
...
**Wood Magic.** You learn the magic of the primeval woods, which are revered and protected by your people. You gain the following magical abilities:

- **Druidic Cantrip.** You learn one druid cantrip of your choice.

- **Woodland Spells.** You learn the *longstrider* and *pass without trace* spells, each of which you can cast once without expending a spell slot. You regain the ability to cast these two spells in this way when you finish a long rest. You can also cast these spells using any spell slots you have.
...
Spellmarks are hereditary magical sigils that manifest on the skin of certain bloodlines, granting their bearers innate supernatural abilities ranging from minor cantrips to powerful spell-like effects. These intricate, tattoo-like patterns typically appear during adolescence and grow more elaborate as the bearer's power develops, with each bloodline's spellmarks producing a distinct set of related abilities—some might grant mastery over flame and forge, others command beasts or manipulate the winds, while still others facilitate communication, healing, or travel across vast distances. The marked houses that carry these bloodlines have historically leveraged their unique gifts to establish powerful mercantile dynasties and guilds, turning what might have been seen as mere curiosities into the foundation of entire economies. Spellmarks cannot be taught or transferred; they pass only through blood, making these families both privileged and politically complex fixtures in societies where they appear. In the world of Eberron, these mystical brands are known as dragonmarks, tied to ancient draconic prophecy and borne by thirteen great houses that have shaped the destiny of nations.

### Abberant Spellmark
***Prerequisite: Can't have another Spellmark Feat***  
...
**Spells of the Mark.** When you gain this feature, choose one spell from the sorcerer spell list for each spell level from 1st through 5th. If you have the Spellcasting or Pact Magic feature, the chosen spells are added to your class spell list. Once you choose these spells, they cannot be changed.

**Aberrant Flaw.** You also develop a random flaw from the Aberrant Spellmark Flaws table.  

##### Aberrant Spellmark Flaws
|d8	|Flaw|
|:-:|:--------:|
...
**Death's Insight.** When you make an Intelligence (Religion) or Wisdom (Medicine) check, you can roll a d4 and add the number rolled to the ability check.

**Grave Magic.** You always have the *cause fear* spell prepared. You can cast it once without expending a spell slot, and you regain the ability to cast it in that way when you finish a long rest. You can also cast it using any spell slots you have of the appropriate level. Intelligence, Wisdom, or Charisma is your spellcasting ability for this spell (choose when you select this feat). When you reach character level 3, you also always have the *gentle repose* spell prepared and can cast it in the same way.

**Spells of the Mark.** If you have the Spellcasting or Pact Magic class feature, the spells on the Mark of Death Spells table are added to your spell list.
...
**Magical Detection.** You always have the *detect magic* and *detect poison and disease* spells prepared. You can cast each spell once without expending a spell slot, and you regain the ability to cast it this way when you finish a long rest. You can also cast these spells using any spell slots you have of the appropriate level. Intelligence, Wisdom, or Charisma is your spellcasting ability for these spells (choose when you select this feat). When you reach character level 3, you also always have the *see invisibility* spell prepared and can cast it in the same way.

**Spells of the Mark.** If you have the Spellcasting or Pact Magic class feature, the spells on the Mark of Detection Spells table are added to your spell list.
...
**Hunter's Intuition.** When you make a Wisdom (Perception or Survival) check, you can roll a d4 and add the number rolled to the ability check.

**Finder's Magic.** You always have the *hunter's mark* spell prepared. You can cast it once without expending a spell slot, and you regain the ability to cast it in that way when you finish a long rest. You can also cast it using any spell slots you have of the appropriate level. Intelligence, Wisdom, or Charisma is your spellcasting ability for this spell (choose when you select this feat). When you reach character level 3, you also always have the *locate object* spell prepared and can cast it in the same way.

**Spells of the Mark.** If you have the Spellcasting or Pact Magic class feature, the spells on the Mark of Finding Spells table are added to your spell list.
...
**Wild Intuition.** When you make an Intelligence (Nature) or Wisdom (Animal Handling) check, you can roll a d4 and add the number rolled to the ability check.

**Primal Connection.** You always have the *animal friendship* and *speak with animals* spells prepared. You can cast each spell once without expending a spell slot, and you regain the ability to cast it in that way when you finish a long rest. You can also cast these spells using any spell slots you have. Intelligence, Wisdom, or Charisma is your spellcasting ability for these spells (choose when you select this feat).
...
**Spells of the Mark.** If you have the Spellcasting or Pact Magic class feature, the spells on the Mark of Handling Spells table are added to your spell list.
...
**Healing Touch.** You always have the *cure wounds* spell prepared. You can cast it once without expending a spell slot, and you regain the ability to cast it in that way when you finish a long rest. You can also cast it using any spell slots you have of the appropriate level. Intelligence, Wisdom, or Charisma is your spellcasting ability for this spell (choose when you select this feat). When you reach character level 3, you also always have the *lesser restoration* spell prepared and can cast it in the same way.

**Spells of the Mark.** If you have the Spellcasting or Pact Magic class feature, the spells on the Mark of Healing Spells table are added to your spell list.
...
**Ever Hospitable.** When you make a Charisma (Persuasion) check or an ability check using Brewer’s Supplies or Cook’s Utensils, you can roll a d4 and add the number rolled to the ability check.

**Innkeeper’s Magic.** You always have the *purify food and drink* and *unseen servant* spells prepared. You can cast each spell once without expending a spell slot, and you regain the ability to cast it in that way when you finish a long rest. You can also cast these spells using any spell slots you have of the appropriate level. Intelligence, Wisdom, or Charisma is your spellcasting ability for these spells (choose when you select this feat). When you reach character level 3, you also always have the *calm emotions* spell prepared and can cast it in the same way.

**Spells of the Mark.** If you have the Spellcasting or Pact Magic class feature, the spells on the Mark of Hospitality Spells table are added to your spell list.
...
**Artisan’s Intuition.** When you make an Intelligence (Arcana) check or an ability check using Artisan’s Tools, you can roll a d4 and add the number rolled to the ability check.

**Spellsmith.** You know the *mending* cantrip. You also always have the *magic weapon* spell prepared. You can cast it once without expending a spell slot, and you regain the ability to cast it in that way when you finish a long rest. You can also cast it using any spell slots you have. Intelligence, Wisdom, or Charisma is your spellcasting ability for these spells (choose when you select this feat).

**Spells of the Mark.** If you have the Spellcasting or Pact Magic class feature, the spells on the Mark of Making Spells table are added to your spell list.
...
**Intuitive Motion.** When you make a Strength (Athletics) or Dexterity (Acrobatics) check, you can roll a d4 and add the number rolled to the ability check.

**Magical Passage.** You always have the *misty step* spell prepared. You can cast it once without expending a spell slot, and you regain the ability to cast it in that way when you finish a long rest. You can also cast it using any spell slots you have. Intelligence, Wisdom, or Charisma is your spellcasting ability for this spell (choose when you select this feat).

**Spells of the Mark.** If you have the Spellcasting or Pact Magic class feature, the spells on the Mark of Passage Spells table are added to your spell list.
...
**Scribe’s Insight.** You know the *message* cantrip. You also always have the *comprehend languages* spell prepared. You can cast it once without expending a spell slot, and you regain the ability to cast it in that way when you finish a long rest. You can also cast it using any spell slots you have of the appropriate level. Intelligence, Wisdom, or Charisma is your spellcasting ability for this spell (choose when you select this feat). When you reach character level 3, you also always have the *magic mouth* spell prepared and can cast it in the same way.

**Spells of the Mark.** If you have the Spellcasting or Pact Magic class feature, the spells on the Mark of Scribing Spells table are added to your spell list.
...
**Sentinel’s Intuition.** When you make a Wisdom (Insight or Perception) check, you can roll a d4 and add the number rolled to the ability check.

**Guardian’s Shield.** You always have the *shield* spell prepared. You can cast it once without expending a spell slot, and you regain the ability to cast it in that way when you finish a long rest. You can also cast it using any spell slots you have. Intelligence, Wisdom, or Charisma is your spellcasting ability for this spell (choose when you select this feat).

**Vigilant Guardian.** When a creature you can see within 5 feet of you is hit by an attack roll, you can take a reaction to swap places with that creature, and you are hit by the attack instead. You can use this feature a number of times equal to your proficiency bonus, and you regain all expended uses when you finish a long rest.

**Spells of the Mark.** If you have the Spellcasting or Pact Magic class feature, the spells on the Mark of Sentinel Spells table are added to your spell list.
...
**Cunning Intuition.** When you make a Dexterity (Stealth) or Charisma (Performance) check, you can roll a d4 and add the number rolled to the ability check.

**Shape Shadows.** You know the *minor illusion* cantrip. You also always have the *invisibility* spell prepared. You can cast it once without expending a spell slot, and you regain the ability to cast it in that way when you finish a long rest. You can also cast it using any spell slots you have of the appropriate level. Intelligence, Wisdom, or Charisma is your spellcasting ability for these spells (choose when you select this feat).

**Spells of the Mark.** If you have the Spellcasting or Pact Magic class feature, the spells on the Mark of Shadow Spells table are added to your spell list.
...
**Windwright’s Intuition.** When you make a Dexterity (Acrobatics) check or an ability check using Navigator’s Tools, you can roll a d4 and add the number rolled to the ability check.

**Storm’s Boon.** You have resistance to lightning damage.

**Storm Magic.** You know the *thunderclap* cantrip. When you reach character level 3, you also always have the *gust of wind* spell prepared. You can cast it once without expending a spell slot, and you regain the ability to cast it in that way when you finish a long rest. You can also cast it using any spell slots you have of the appropriate level. Intelligence, Wisdom, or Charisma is your spellcasting ability for these spells (choose when you select this feat).

**Spells of the Mark.** If you have the Spellcasting or Pact Magic class feature, the spells on the Mark of Storm Spells table are added to your spell list.
...
**Wards and Seals.** You always have the *alarm* and *mage armor* spells prepared. You can cast each spell once without expending a spell slot, and you regain the ability to cast it in that way when you finish a long rest. You can also cast these spells using any spell slots you have of the appropriate level. Intelligence, Wisdom, or Charisma is your spellcasting ability for these spells (choose when you select this feat). When you reach character level 3, you also always have the *arcane lock* spell prepared and can cast it in the same way.

**Spells of the Mark.** If you have the Spellcasting or Pact Magic class feature, the spells on the Mark of Warding Spells table are added to your spell list.
...
***Prerequisite: Level 4+, Aberrant Spellmark***  
You gain the following benefits.

**Ability Score Increase.** Increase your Constitution score by 1, to a maximum of 20.

**Improved Fortitude.** When you use the Aberrant Fortitude benefit of your Aberrant Spellmark feat, you can roll 1d6 instead of 1d4. You also now regain your use of Aberrant Fortitude whenever you finish a short or long rest.

**Mark of Inspiration.** When you cast a cantrip, you can roll one or two of your unexpended Hit Point Dice. You gain a number of temporary hit points equal to the number rolled plus your Constitution modifier, and one creature of your choice within 30 feet of you (not including you) takes force damage equal to the temporary hit points you gained. Those dice are then expended.

### Greater Mark of Death

***Prerequisite: Level 4+, Mark of Death***  
You gain the following benefits.

**Ability Score Increase.** Increase one ability score of your choice by 1, to a maximum of 20.

**Improved Insight.** When you use the Death’s Insight benefit of your Mark of Death feat, you can roll 1d6 instead of 1d4.

**Lingering Repose.** Whenever you cast *gentle repose*, the spell’s duration becomes 20 days, and any spell that would restore that creature to life requires only half the normal amount of diamond dust or other material components.
...
**Shared Detection.** Whenever you cast *see invisibility*, you can choose one creature you can see within 30 feet of yourself. That creature also gains the benefits of the spell for its duration.
...
**Improved Finding.** Whenever you cast *hunter’s mark*, the range of the spell is doubled, and you can modify the spell so that the target can’t benefit from the Invisible condition for the duration.
...
**Improved Making.** Whenever you cast *magic weapon*, you cast the spell as if you spent a Spell Slot of 1 level higher.
...
**Improved Passage.** Whenever you cast *misty step*, you can also choose up to two willing creatures you can see within 30 feet of yourself before you teleport. Each target can then take a reaction to also teleport up to 30 feet to an unoccupied space it can see.
...
**Improved Shadow.** Whenever you cast *invisibility*, you cast it as if you used a Spell Slot 1 level higher.
...
**Improved Storm.** Whenever you cast *gust of wind*, you also gain a flying speed of 60 feet for the duration of the spell.
...
***Prerequisite: Level 4+, Any Spellmark Feat***  
You gain the following benefits.

**Ability Score Increase.** Increase the spellcasting ability score used by your Spellmark feat by 1, to a maximum of 20.

**Spellmark Preparation.** You always have the spells on your Spells of the Mark list (if any) prepared.

**Spellmark Spellcasting.** You gain one additional spell slot that you can use only to cast spells granted by your Spellmark feat or prepared through the Spellmark Preparation benefit of this feat. The level of this spell slot depends on your character level, as shown in the Spellmark Spell Slot table below. You regain the expended spell slot when you finish a short or long rest.

#### Spellmark Spell Slot
